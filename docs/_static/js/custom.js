...
function addCustomFooter() {
    ...
    questionOrIssue.innerHTML =
        ...
        " or <a href='https://github.com/huggingface/transformers'>Create an issue</a>";
    ...
    const imageDetails = [
        {
            ...
            imageLink:
                "https://huggingface.co/landing/assets/transformers-docs/website.svg"
        },
        {
            link: "https://twitter.com/huggingface",
            imageLink:
                "https://huggingface.co/landing/assets/transformers-docs/twitter.svg"
        },
        {
            link: "https://github.com/huggingface",
            imageLink:
                "https://huggingface.co/landing/assets/transformers-docs/github.svg"
        },
        {
            link: "https://www.linkedin.com/company/huggingface/",
            imageLink:
                "https://huggingface.co/landing/assets/transformers-docs/linkedin.svg"
        }
    ];
    ...
    const div = `
        <div class="github-repo">
            <a class="github-button"
               ...
               aria-label="Star huggingface/transformers on GitHub">
                Star
            </a>
        </div>
    `;
    document
        .querySelector(".wy-side-nav-search .icon-home")
...
function addVersionControl() {
    ...
    versionMenu.innerHTML = Object.entries(versionMapping[language])
        .map(([key, value]) => {
...
function parseGithubButtons() {
    ...
    var e = window.document,
        ...
        d =
            c &&
            a &&
            a.prototype.attachShadow &&
            !a.prototype.attachShadow.prototype,
        s = function (e, t, o) {
            e.addEventListener
        ...
        f = function (e, t, o) {
            var r = function (n) {
                if (t.test(e.readyState))
                    return u(e, "readystatechange", r), o(n);
            };
            ...
            return function (t, o, r) {
                ...
                if (o)
                    for (var a in o) {
                        var i = o[a];
                        null != i &&
                            (null != n[a] ? (n[a] = i) : n.setAttribute(a, i));
                    }
                if (r)
        ...
        C = function (e) {
            return (
                (y > 1 ? n.ceil((n.round(e * y) / y) * 2) / 2 : n.ceil(e)) || 0
            );
        },
        F = function (e, t) {
    ...
    t.protocol + "//" + t.host + t.pathname === l
        ? x(
              ...
              (function (e) {
                  for (
                      var t = {}, o = e.split("&"), n = 0, a = o.length;
                      n < a;
                      n++
                  ) {
                      var i = o[n];
                      if ("" !== i) {
                          var l = i.split("=");
                          t[r(l[0])] =
                              null != l[1] ? r(l.slice(1).join("=")) : void 0;
                      }
                  }
                  return t;
