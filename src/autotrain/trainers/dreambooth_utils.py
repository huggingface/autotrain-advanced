...
class DreamBoothDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.self.instance_unet_added_conditions is not None:
        ...
        if self.class_data_root:
            ...
            if self.class_unet_added_conditions is not None:
...
def collate_fn(examples, config):
    ...
    if config.xl:
        batch.update["unet_added_conditions"] = {
...
def encode_prompt_xl(text_encoders, tokenizers, prompt):
    prompt_embeds_list = []
