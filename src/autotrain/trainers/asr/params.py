...
class WhisperTrainingParams:
    ...
    def __post_init__(self):
        ...
        valid_optimizers = [
            ...
            "adamw_torch_4bit", "ademamix", "sgd", "adagrad", "adamw_bnb_8bit", "adamw_8bit", 
            "ademamix_8bit", "lion_8bit", "lion_32bit", "paged_adamw_32bit", "paged_adamw_8bit", 
            ...
            "grokadamw", "schedule_free_adamw", "schedule_free_sgd"
        ]
